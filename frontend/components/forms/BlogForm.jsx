...
const BlogForm = ({ mode = 'create', initialValues = null, onSuccess, onCancel }) => {
	...
	useEffect(() => {
		if (mode === 'edit' && initialValues) {
			...
			// Handle PDF preview - extract filename from URL or object
			...
			// Handle taskPdfs preview - safely extract filenames from array of objects
	...
	const handleSubmit = async (e) => {
		...
		setLoading(true)
		try {
			// Include deleted file IDs in the form data
			const submitData = {
				...formData,
